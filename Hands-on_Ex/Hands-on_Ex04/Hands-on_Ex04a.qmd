...
[**ggstatsplot**](https://indrajeetpatil.github.io/ggstatsplot/) ![](https://r4va.netlify.app/chap10/img/image1.jpg){width="41" height="46"} is an extension of [**ggplot2**](https://ggplot2.tidyverse.org/) package for creating graphics with details from statistical tests included in the information-rich plots themselves.
...
![](images/clipboard-3819306550.png){width="451"}
